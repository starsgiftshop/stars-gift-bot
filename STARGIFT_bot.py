...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    caption = (
        "🌟 <b>STARGIFT SHOP</b> — siz izlagan sifat shu yerda!\n\n"
        "⭐ Stars • 🎁 Gift • 💎 Premium — barchasi bir joyda.\n\n"
        "⚡ Tezkor xizmat\n"
        "🔐 Ishonchli va xavfsiz\n"
        "💰 Hamyonbop narxlar\n"
        "🚀 Buyurtmalar tez bajariladi\n\n"
        "❤️ <b>Halollik va ishonch — bizning asosiy qadriyatimiz.</b>\n"
        "👑 OWNER: @Shamsbekman"
    )
    if os.path.exists(START_IMAGE):
        ...
        await update.message.reply_text(
            caption, parse_mode="HTML", reply_markup=menu()
        )
